...
# Устанавливаем менеджеры в routes перед подключением роутера
routes.set_managers(manager_obj, processor_obj)
...
# Middleware для добавления зависимостей в HTTP запросы
@app.middleware("http")
